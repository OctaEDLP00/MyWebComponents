export class BadgeAlphaElement extends HTMLElement {
  size: Size = 'md'
  ...
  static define(tag = 'badge-alpha', registry = customElements) {
    if (!registry.get(tag)) {
  ...
  render() {
    ...
    this.shadowRoot.setHTMLUnsafe(/* html */ `
			<style>${BadgeAlphaElement.styles()}</style>
...
try {
  root.BadgeAlphaElement = BadgeAlphaElement.define()
} catch (e: unknown) {
  if (
