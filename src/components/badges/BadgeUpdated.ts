export class BadgeUpdatedElement extends HTMLElement {
  size: Size = 'md'
  ...
  static define(tag = 'badge-updated', registry = customElements) {
    if (!registry.get(tag)) {
  ...
  render() {
    ...
    this.shadowRoot.setHTMLUnsafe(/* html */ `
			<style>${BadgeUpdatedElement.styles()}</style>
...
try {
  root.BadgeUpdatedElement = BadgeUpdatedElement.define()
} catch (e: unknown) {
  if (
