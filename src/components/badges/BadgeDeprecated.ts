export class BadgeDeprecatedElement extends HTMLElement {
  size: Size = 'md'
  ...
  static define(tag = 'badge-deprecated', registry = customElements) {
    if (!registry.get(tag)) {
  ...
  render() {
    ...
    this.shadowRoot.setHTMLUnsafe(/* html */ `
			<style>${BadgeDeprecatedElement.styles()}</style>
...
try {
  root.BadgeDeprecatedElement = BadgeDeprecatedElement.define()
} catch (e: unknown) {
  if (
