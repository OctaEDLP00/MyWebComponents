export class BadgeSuccessElement extends HTMLElement {
  size: Size = 'md'
  ...
  static define(tag = 'badge-success', registry = customElements) {
    if (!registry.get(tag)) {
  ...
  render() {
    ...
    this.shadowRoot.setHTMLUnsafe(/* html */ `
			<style>${BadgeSuccessElement.styles()}</style>
...
try {
  root.BadgeSuccessElement = BadgeSuccessElement.define()
} catch (e: unknown) {
  if (
